...
function mrinfm() {
  ...
  var fullname_err = stateofresidents_err = lgaofresidents_err = residentialaddress_err = mobilenumber_err = email_err = availability_err = skillexperience_err = caca_err = true; 
    ...
    var erMesg = '';
      ...
      // Validate fullname
      if(myTrim(fullname) == "") {
       erMesg += `<i class="fa fa-asterisk"></i> Enter Your Full Name <br>`;
  } else {
      ...
      erMesg += `<i class="fa fa-asterisk"></i> Select Your State Of Residence <br>`;
  } else {
      // Check if its lesser than 0
      ...
      erMesg += `<i class="fa fa-asterisk"></i> Select Your Local Government Of Residence <br>`;
  } else {
      // Check if its lesser than 0
      ...
      erMesg += `<i class="fa fa-asterisk"></i> Enter Your Residential Address <br>`;
  } else {
      // Check if its lesser than 0
  ...
  if(myTrim(mobilenumber) == "") {
      erMesg += `<i class="fa fa-asterisk"></i> Enter Your Mobile Number <br>`;
  } else {
      if(myTrim(mobilenumber).length !== 11){
          erMesg += `<i class="fa fa-asterisk"></i> Enter a Valid Mobile Number <br>`;
      } else{
      ...
      // Validate email
      if(myTrim(email) == "") {
      erMesg += `<i class="fa fa-asterisk"></i> Enter a Valid Your Email Address <br>`;
  } else {
      // Check if its lesser than 0
      if(myTrim(email).length < 0) {
          erMesg += `<i class="fa fa-asterisk"></i> Enter a Valid Email Address <br>`;
      } else{
          email_err = false;
      }
  }
      ...
      erMesg += `<i class="fa fa-asterisk"></i> Enter When You Are Always Available <br>`;
  } else {
      // Check if its lesser than 0
      ...
      erMesg += `<i class="fa fa-asterisk"></i> Enter Your Skill Experience <br>`;
  } else {
      // Check if its lesser than 0
      ...
      // Validate caca
      if(myTrim(caca) == "") {
      erMesg += `<i class="fa fa-asterisk"></i> You Entered the Wrong Captcha Characters <br>`;
  } else {
      // Check if its lesser than 0
